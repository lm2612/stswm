...
C 14-02-17 ADDED TEST 8 L. MANSFIELD
C
C---- Model Parameters -------------------------------------------------
C
      INCLUDE 'params.i'
...
C
     ...
     $     RADIUS, DIST, MOUNTA, HSYM, HBAMP, HB, HC,  HASYM
C
...
C
C---------------------INITIAL CONDITION 8 -------------------------
C
C     CYCLONIC POLAR VORTEX DESCRIBED IN THUBURN AND LAGNEAU 1999
C     LOWER BOUNDARY HEIGHT CREATES THIS
C     SYMMETRIC PART ONLY (HSYM)
C
      WRITE(6,800)
  800 FORMAT(/,' TEST CASE #8: POLAR VORTEX')
C    
C     SET MOUNTAIN SURFACE
