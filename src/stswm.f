...
C 02-02-2017 CHANGE TO OUTPUT TO AVOID OBSELETE NETCDF ROUTINES (J. METHVEN)
C
C---- Model Parameters -------------------------------------------------
C
      INCLUDE 'params.i'
...
C
      IF (TAUO .LE. TAUE) THEN
         OCTR = 1
c         CALL OUTPTP (ZETASC,DIVSC,PHISC,PHIBAR,LDIAG,.TRUE.,OCTR)
         CALL OUTSPEC(ZETASC,DIVSC,PHISC,PHIBAR,OCTR)
      ENDIF
C
C'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
C''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
C
      ...
      IF (OUT) THEN
         OCTR = OCTR + 1
C         CALL OUTPTP (ZETASC,DIVSC,PHISC,PHIBAR,LDIAG,.FALSE.,OCTR)
         CALL OUTSPEC(ZETASC,DIVSC,PHISC,PHIBAR,OCTR)
      ENDIF
C'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
